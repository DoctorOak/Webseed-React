    ...
    return (
        <section className="work-page">
            ...
            <section className={"work-items"}>
                ...
                <WorkItem title={"Webseed"} img={"/mockups/webseed/webseed-mockup.png"} screensFolder={'/mockups/webseed'} buttonText='View Source' url={"https://www.mypokemonjournal.com"} tags={['React', 'NodeJS', 'AWS']}>
                    ...
                    <p>The site is deployed on an AWS EC2 instance, with continuous integration powered by Laravel Forge.</p>
